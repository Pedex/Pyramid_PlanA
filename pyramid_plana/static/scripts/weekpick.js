    ...
    $.fn.weekpicker = function (options, func) {
        ...
        var selectWeek = function (date, hideOnSelect) {
            ...
            if (date) {
                ...
                $this.val("week " + week + " (" + defaults.startDate.toDateString() + ")");
                }
     ...
     $('.weekcalendar table.ui-datepicker-calendar tr').off().on({
...
$(function(){
    ...
    $("#today").click(function(){
        $("#abc").weekpicker("setDate", new Date());
    });
    $("#abc").weekpicker("onSelect", function(start, end){
     updatePlannerEventEntries(start, end);
     updatePlannerDateEntries(start, end);
    });
});
